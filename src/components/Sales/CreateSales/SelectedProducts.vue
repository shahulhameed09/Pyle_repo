<template>
  ...
  <div class="card border-0 shadow-none rounded-1 mb-30 pb-70 table-responsive">
        ...
        <table class="table text-nowrap align-middle">
          ...
          <tbody>
            <tr v-for="(product, index) in filteredList" :key="product.id">
              ...
              <td class="shadow-none lh-1 fs-14 fw-normal text-paragraph">
                <v-select v-model="product.gstValue" :options="gst" label="gstRate"
                  v-on:change="calculateSubtotal(index)" v-on:input="calculateSubtotal(index)"
                  v-on:select="calculateSubtotal(index)" v-on:search="calculateSubtotal(index)"
